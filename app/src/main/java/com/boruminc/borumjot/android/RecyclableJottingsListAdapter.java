...
public class RecyclableJottingsListAdapter extends RecyclerView.Adapter<RecyclableJottingsListAdapter.JottingViewHolder> {
    ...
    @NonNull
    @Override
    public JottingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.jotting_list_item, parent, false);

        return new JottingViewHolder(view, context);
    }
    ...
    public int getItemCount() {
        return jottingData.size();
    }

    static class JottingViewHolder extends RecyclerView.ViewHolder implements JottingListViewHolderBase, View.OnLongClickListener {

        private TextView jottingName;
        private SerializableImage pinIcon;

        private Context context;

        JottingViewHolder(View v, Context ct) {
            super(v);
            context = ct;
            setViewProperties(v);
        }
        ...
        public void setViewProperties(View v) {
            ...
            jottingName = v.findViewById(R.id.jotting_name);
            jottingName.setOnClickListener(this::navToJot);
            jottingName.setTextColor(Color.BLACK);

            pinIcon.setOnLongClickListener(this);
            jottingName.setOnLongClickListener(this);
            ...
            jottingName.setPadding(padding, padding, 0, padding);
        }

        @Override
        public void bindView(Object data) {
            Jotting jottingInst = (Jotting) data;
            jottingName.setText(jottingInst.getName());
            jottingName.setTag(jottingInst);
        ...
        void navToJot(View v) {
            ...
            if (jottingIntent.hasExtra("data")) {
                ...
                Toast.makeText(getContext(), "An error occurred in viewing your jotting", Toast.LENGTH_SHORT).show();
        }
